...
#ifndef _WIN32
#ifdef SOCKETS_USE_MUSL
#define IPV6_INFO_PORT(ipv6_info) ((ipv6_info)->sin6_addr.__in6_union.__s6_addr)
#else
#define IPV6_INFO_PORT(ipv6_info) ((ipv6_info)->sin6_addr.__in6_u.__u6_addr8)
#endif
#endif
